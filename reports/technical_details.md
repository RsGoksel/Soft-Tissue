...
| Sempozyum abstract — Kol A (forward) | ✅ [abstract_a_en.pdf](abstract_a_en.pdf) · [abstract_a_tr.pdf](abstract_a_tr.pdf) |
| Sempozyum abstract — Kol B (inverse) | ✅ Hazır — [abstract_b_en.pdf](abstract_b_en.pdf) · [abstract_b_tr.pdf](abstract_b_tr.pdf) |
...
| Fizik brifingi + I/O spec + literatür notları | ✅ [physics_first_brief.md](physics_first_brief.md), [inputs_and_normalization.md](inputs_and_normalization.md), [literature_notes.md](literature_notes.md) |
| Teslim paketi | ✅ `sent.zip` (5.2 MB, 21 dosya) |
| Sonraki iterasyon: transfer learning + 500 örnek | ⏳ Plan netleşti — [future_work_ai.md](future_work_ai.md) |
...
➜ [`future_work_ai.md`](future_work_ai.md)
...
|---|---|---|---|
| **A — Forward (FNO)** | [abstract_a_en.pdf](abstract_a_en.pdf) | [abstract_a_tr.pdf](abstract_a_tr.pdf) | Klinik motivasyon + k-Wave wallclock kıyası + veri seti gerekçesi + omurga ablasyon novelty |
| **B — Inverse (3-DOF)** | [abstract_b_en.pdf](abstract_b_en.pdf) | [abstract_b_tr.pdf](abstract_b_tr.pdf) | Gauge-aware reformulation + örnek-verimlilik + 5° kuantizasyon + 5 klasik gold-standard ile çoklu-seed kıyas |
| _(legacy birleşik)_ | [abstract_en.pdf](abstract_en.pdf) | [abstract_tr.pdf](abstract_tr.pdf) | Pazartesi'ye kadar referans amaçlı |

- **Ana görsel rapor**: [`sonuclar.pdf`](sonuclar.pdf)
- **Toplantı hazırlık dokümanları**:
  - [`pazartesi_toplanti.md`](pazartesi_toplanti.md) — **Pazartesi 28.04 toplantı gündemi**, tüm tartışılacak konular
  - [`physics_first_brief.md`](physics_first_brief.md) — fizik perspektifinden anlatım
  - [`inputs_and_normalization.md`](inputs_and_normalization.md) — model girdi/çıktı tam spesifikasyonu
  - [`literature_notes.md`](literature_notes.md) — danışmanın paylaştığı IEEE referansları
...
[`abstract_en.pdf`](abstract_en.pdf),
[`sonuclar.pdf`](sonuclar.pdf).
...
| **[`sonuclar.pdf`](sonuclar.pdf)** | Ekran paylaşımı için uygun görsel rapor | 1.5 MB |
| **Sempozyum abstract'ları** (Kol A + Kol B, EN + TR) | [a_en](abstract_a_en.pdf), [a_tr](abstract_a_tr.pdf), [b_en](abstract_b_en.pdf), [b_tr](abstract_b_tr.pdf) | ~400 KB toplam |
| **Toplantı brief'leri** | [physics_first_brief.md](physics_first_brief.md), [inputs_and_normalization.md](inputs_and_normalization.md), [literature_notes.md](literature_notes.md) | — |
...
- [`abstract_a_en.pdf`](abstract_a_en.pdf) · [`abstract_a_tr.pdf`](abstract_a_tr.pdf) — Kol A (forward FNO) abstract'ı
- [`abstract_b_en.pdf`](abstract_b_en.pdf) · [`abstract_b_tr.pdf`](abstract_b_tr.pdf) — Kol B (inverse 3-DOF) abstract'ı
- [`sonuclar.pdf`](sonuclar.pdf) — görsel rapor (ekran paylaşımına uygun)
- [`physics_first_brief.md`](physics_first_brief.md) — fizik anlatımı (AI minimal)
- [`inputs_and_normalization.md`](inputs_and_normalization.md) — model girdi/çıktı tam spec
- [`literature_notes.md`](literature_notes.md) — IEEE referansları + niyet sorusu
- [`pazartesi_toplanti.md`](pazartesi_toplanti.md) — toplantı gündemi
- [`future_work_ai.md`](future_work_ai.md) — cutting-edge mimari yol haritası
...
- [`../outputs/focus_arch_compare/gold_standard.md`](../outputs/focus_arch_compare/gold_standard.md) — gold-standard kıyas tablosu
